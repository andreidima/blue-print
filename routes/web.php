...
use App\Http\Controllers\NomenclatorEchipamentController;
use App\Http\Controllers\NomenclatorMaterialController;
...
Route::middleware(['auth', 'checkUserActiv'])->group(function () {
    ...
    Route::get('/materiale/select-options', [NomenclatorMaterialController::class, 'selectOptions'])->name('materiale.select-options');
    Route::get('/echipamente/select-options', [NomenclatorEchipamentController::class, 'selectOptions'])->name('echipamente.select-options');
    ...
    Route::resource('/materiale', NomenclatorMaterialController::class)->parameters(['materiale' => 'materiale'])->names('materiale');
    ...
    Route::post('/comenzi/{comanda}/produse/{linie}/consumuri', [ComandaController::class, 'storeProdusConsum'])->name('comenzi.produse.consumuri.store');
    Route::put('/comenzi/{comanda}/produse/{linie}/consumuri/{consum}', [ComandaController::class, 'updateProdusConsum'])->name('comenzi.produse.consumuri.update');
    Route::delete('/comenzi/{comanda}/produse/{linie}/consumuri/{consum}', [ComandaController::class, 'destroyProdusConsum'])->name('comenzi.produse.consumuri.destroy');
