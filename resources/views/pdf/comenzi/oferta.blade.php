...
<html lang="ro">
    <head>
        <meta charset="utf-8">
        <title>Oferta comanda #{{ $comanda->id }}</title>
        <style>
            @page {
                margin: 24px 28px;
            }
    ...
    <body>
        ...
        <h1>Oferta comanda #{{ $comanda->id }}</h1>
        ...
        <div class="meta-grid">
            ...
            <div class="meta-col">
                ...
                <div class="meta-item"><span class="meta-label">Valabilitate oferta:</span> {{ optional($comanda->valabilitate_oferta)->format('d.m.Y') ?? '-' }}</div>
