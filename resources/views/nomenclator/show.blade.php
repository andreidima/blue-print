...
<div class="mx-3 px-3 card" style="border-radius: 40px 40px 40px 40px;">
    <div class="row card-header align-items-center" style="border-radius: 40px 40px 0px 0px;">
        <div class="col-lg-6">
            <span class="badge culoare1 fs-5">
                <i class="fa-solid fa-list me-1"></i> Intrare nomenclator: {{ $nomenclator->denumire }}
            </span>
        </div>
        <div class="col-lg-6 text-end">
            <a class="btn btn-sm btn-primary text-white border border-dark rounded-3 me-2" href="{{ route('nomenclator.edit', $nomenclator) }}">
    ...
    <div class="card-body px-3 py-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                <div class="p-3 rounded-3 bg-light">
                    <div class="mb-2"><strong>Creat la:</strong> {{ optional($nomenclator->created_at)->format('d.m.Y H:i') }}</div>
                    <div><strong>Actualizat la:</strong> {{ optional($nomenclator->updated_at)->format('d.m.Y H:i') }}</div>
                </div>
            </div>
        </div>
    </div>
