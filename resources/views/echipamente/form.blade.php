<div class="row mb-4 pt-2 rounded-3" style="border:1px solid #e9ecef; border-left:0.25rem darkcyan solid; background-color:rgb(241, 250, 250)">
    <div class="col-lg-8 mb-4">
        ...
        <input
            ...
            name="denumire"
            id="denumire"
            value="{{ old('denumire', $echipament->denumire ?? '') }}"
            required
        >
    </div>
    <div class="col-lg-4 mb-4">
        <div class="form-check mt-4 ps-4">
            <input class="form-check-input" type="checkbox" name="activ" id="activ" value="1"
                {{ old('activ', $echipament->activ ?? true) ? 'checked' : '' }}>
...
<div class="row">
    <div class="col-lg-12 mb-2 d-flex justify-content-center">
        ...
        @endif
        <a class="btn btn-secondary rounded-3" href="{{ Session::get('returnUrl', route('echipamente.index')) }}">
            Renunta
        </a>
    </div>
</div>
